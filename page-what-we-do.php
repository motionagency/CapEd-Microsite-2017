					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-7">
								...
								<h3>Faculty Recruitment &amp; Training</h3>
								<p>CapEd will facilitate and support access to part-time/adjunct content and online facilitation experts that have been trained and certified through the CapEd faculty training approach.</p>
							</div>
						</div>
					</div>
		</div>
