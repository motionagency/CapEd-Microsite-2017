...
<section class="what-we-do-tabs">
	...
	<div class="tab-content">
		<div role="tappanel" class="tab-pane fade show active" id="collaboration">
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-7">
									...
									<p>CapEd evaluates and maps the student experience through the partner’s systems and develops a solutions programs to serve for consultative intervention. Documented policies and procedures are intentionally systemized to efficiently scale with the institution’s online growth requiring sub-sets of existing resources at launch and benchmarks to indicate additional resources as growth demands.</p>
		...
		<div role="tappanel" class="tab-pane fade" id="academic">
		...
		<div role="tappanel" class="tab-pane fade" id="promotion">
		...
		<div role="tappanel" class="tab-pane fade" id="enrollment">
		...
		<div role="tappanel" class="tab-pane fade" id="delivery">
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-7">
								...
								<p>CapEd provides technical support services for students and faculty participating in Virtual Campus coursework.</p>
								<h3>Faculty Development &amp; Facilitation Support</h3>
